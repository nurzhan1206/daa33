...
class PrimAlgorithmTest {
    ...
    @Test
    void testGraph1_Prim() {
        MSTResult result = prim.findMST(g1);
    ...
    @Test
    void testGraph2_Prim() {
        MSTResult result = prim.findMST(g2);
        // Проверяем стоимость и кол-во ребер V-1
    ...
    @Test
    void testCostsAreIdentical() {
        // Тест, проверяющий, что оба алгоритма дают одинаковую стоимость
        MSTResult primResult = prim.findMST(g1);
        KruskalAlgorithm kruskal = new KruskalAlgorithm();
        MSTResult kruskalResult = kruskal.findMST(g1);
